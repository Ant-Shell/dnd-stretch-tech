...
const CharacterCreator: FC<Props> = (props: Props) => {
    ...
    return (
        <div className="character-creator">
            ...
            { nameTakenMessage }
            <label>Name:</label> <input type="text" id="name" className="name" title="name" onChange={event => handleChange(event)} value={formData.name} required/>
            <label>Race:</label> <select required id="race" className="race" title="race" value={raceValue} onChange={(event) => handleChange(event)} onClick={() => setRandomizing(false)} >
            ...
            <label>Class:</label> <select required id="classs" className="class" value={classsValue} onChange={(event) => classValueHandler(event)} onClick={() => setRandomizing(false)} >
                ...
                <div><label>HP:</label> <input type="text" id="hp" className="hp" title="hit points" onChange={event => handleChange(event)} value={formData.hp} required/></div>
                <div><label>AC:</label> <input type="text" id="ac" className="ac" title="armor class" onChange={event => handleChange(event)} value={formData.ac} required/></div>
