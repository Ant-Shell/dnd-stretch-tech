...
const CharacterCreator: FC<Props> = (props: Props) => {
  const [formData, setFormData] = useState<CharacterStructure>({
    name: "",
    race: "",
    classs: "",
    hp: "",
  ...
  const randomize = (
    ...
    setRandomizing(true);
    setFormData({
      name: randoData(names) + " the " + randoData(adjectives),
      race: randoData(races),
      classs: randoData(classes),
      hp: randoNumbers(20, 100).toString(),
      ac: randoNumbers(10, 20).toString(),
      str: randoNumbers(8, 20).toString(),
      con: randoNumbers(8, 20).toString(),
      dex: randoNumbers(8, 20).toString(),
      wis: randoNumbers(8, 20).toString(),
      int: randoNumbers(8, 20).toString(),
      cha: randoNumbers(8, 20).toString(),
      about: randoData(backstories),
    });
  };
    ...
    <div className="character-creator">
      ...
      <form onSubmit={(event) => props.submitForm(event, formData)}>
        ...
        <select
          ...
          title="class"
          value={classsValue}
          onChange={(event) => classValueHandler(event)}
          onClick={() => setRandomizing(false)}
        >
